...
let game = {
    ...
    isGameWon() {
        ...
        console.log(this.snake.body.length >= this.settings.winLength);
    ...
    scoreRender(){
        document.querySelector('div#score').innerText = "Вы выиграли " + this.score + " из " +   this.gameiterations;
}

};

window.onload = function () {
    game.init({speed: 3, winLength: 3});
};
